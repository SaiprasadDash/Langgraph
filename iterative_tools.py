...
This is the first draft, so create the post from scratch.
If the topic requires current information, statistics, or recent
developments, use the Tavily search tool before writing.

Return only the final LinkedIn post.
"""
    else:
        user_message = f"""
Rewrite the previous LinkedIn post about this topic:
...
Create an improved version of the post.

Requirements:
- Address every point mentioned in the reviewer feedback.
- Keep the original topic and core message.
- Do not blindly follow feedback if it conflicts with the topic.
...
def reviewer_node(state: State) -> dict:
    """Reviews the draft and decides whether it is ready to publish."""
...
Evaluate it according to your review criteria.

Return only the required VERDICT and FEEDBACK format.
"""
